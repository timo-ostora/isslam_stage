  ...
  /* @__PURE__ */ __name(function Slider2(props, forwardedRef) {
    ...
    function updateValues(value2, atIndex, { commit } = { commit: false }) {
      ...
      setValues((prevValues = []) => {
        ...
        const constrainedValue = preserveThumbOrder ? (0, import_number.clamp)(nextValue, [
          prevValues[atIndex - 1] === void 0 ? min : prevValues[atIndex - 1] + minStepsDistance,
          prevValues[atIndex + 1] === void 0 ? max : prevValues[atIndex + 1] - minStepsDistance
        ]) : nextValue;
        ...
        if (hasMinStepsBetweenValues(nextValues, minStepsDistance)) {
          valueIndexToChangeRef.current = preserveThumbOrder ? atIndex : nextValues.indexOf(constrainedValue);
